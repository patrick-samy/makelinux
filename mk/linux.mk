...
$(LINUX_HEADERS_TARGET): $(ROOTFS_TARGET)
	...
	mkdir -p $(ROOTFS_PATH)/lib/modules/$(LINUX_VERSION)/kernel/extra
...
$(LINUX_IMAGE_TARGET): $(LINUX_HEADERS_TARGET) $(BINUTILS_TARGET) $(CC_TARGET)
	...
	make -C$(SOURCES_PATH)/$(LINUX_DIR) -j$(NB_THREADS) ARCH=$(ARCH) CROSS_COMPILE=$(TOOLS_PATH)/bin/$(TARGET)- $(LINUX_IMAGE_TYPE) LOADADDR=$(LINUX_LOADADDR)
